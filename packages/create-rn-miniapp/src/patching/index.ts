...
const FRONTEND_SAFE_STARTER_INDEX_PAGE = [
  ...
  '        </Txt>',
  '        <Txt typography="t7" color="#4A5568" style={styles.guideItem}>',
  '          2. `AGENTS.md`, `docs/index.md`, `.agents/skills/core/miniapp/SKILL.md`를 먼저 읽어요.',
  '        </Txt>',
  '        <Txt typography="t7" color="#4A5568" style={styles.guideItem}>',
...
const FRONTEND_SAFE_STARTER_ABOUT_PAGE = [
  ...
  '          먼저 `AGENTS.md`, `docs/index.md`, `.agents/skills/core/miniapp/SKILL.md`를 보고 필요한 화면과 데이터 흐름으로 바꿔 주세요.',
  '        </Txt>',
  '      </View>',
  '      <Button',
  '        type="light"',
